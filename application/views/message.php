...
// print_r($student);
	...
	// print_r($row);
		...
		urlencode($msg);
		echo "<br>YOUR MESSAGE:-<br>".$msg;
		echo "<br>";

		$url="https://www.smsgatewayhub.com/api/mt/SendSMS?APIKey=".APIKey."&senderid=".SENDER_ID."&channel=".CHANNEL."&DCS=".DCS."&flashsms=".FLASH_SMS."&number=".$row['mob_no']."&text=".urlencode($msg)."&route=".ROUTE;
